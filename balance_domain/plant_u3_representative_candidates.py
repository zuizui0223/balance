...
def build_u3_representative_candidate_readout(path: Path) -> dict:
    ...
    return {
        ...
        "claim_ceiling": (
            ...
            "not_table_s1_identity_unless_exact_or_independently_resolved"
        ),
    }
