...
def test_matched_extraction_covers_three_pass_pairs():
...
def test_current_matched_lane_has_one_resolved_control_conflict_but_is_not_ready():
    ...
    assert out["case_conflict_status_counts"] == {"POSITIVE": 2, "UNRESOLVED": 1}
...
def test_module_substrate_is_extracted_not_forced_to_match():
    ...
    assert out["control_module_substrate_counts"] == {
        "REPEATED_FLOWERS": 1,
        "SERIAL_WITHIN_FLOWER": 2,
    }
    assert out["n_module_substrate_matched_pairs"] == 2
